...
const TASKS_MODULE = pathToFileURL(path.join(MODELS_DIR, "vision_bundle.mjs")).href;
const WASM_BASE = pathToFileURL(path.join(MODELS_DIR, "wasm")).href;
const MODEL_ASSET_PATH = pathToFileURL(
  path.join(MODELS_DIR, "efficientdet_lite2.tflite")
).href;
