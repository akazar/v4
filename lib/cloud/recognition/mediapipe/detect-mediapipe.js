 ...
 *
 * Use cases:
 * - CLI: run detection on a local file or remote URL and print JSON (e.g. node lib/cloud/recognition/mediapipe/detect-mediapipe.js ./image.jpg or use npm run recognize:mediapipe).
