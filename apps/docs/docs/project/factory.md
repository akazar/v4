...
**Relation to other apps:** Functionally similar to camera/streaming clients; **`apps/factory/`** is the curated “showcase” build referenced from the landing page and docs.
