 ...
 *
 * Consumers:
 *   - lib/cloud/streaming-service/sfu-server-recognition.js (in-process: registers scheduled actions when a
 ...
 * @param {string} [params.serverUrl] - Default http://localhost:3000.
...
export async function runServerPipelineForStream({
    ...
    configPath,
    config,
    serverUrl = process.env.V4_URL || 'http://localhost:3000',
    customModule = null,
} = {}) {
